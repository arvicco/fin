...
module Fin
  ...
  class Instrument < Model
    ...
    prop_accessor [:sess_id, :sess, :session, :session_id] => :i4, #  Номер сессии.
                  ...
                  :is_percent => :i1, #      Фьючерс торгуется в процентах?
                  #                             1 - торгуется в процентах, 0 – не в процентах
                  :percent_rate => :'d6.2', # Процентная ставка для расчета вариационной
                  #                           маржи по процентным фьючерсам.
                  ...
                  :step_price_curr => :'d16.5' # Стоимость минимального шага цены,
    #                                            выраженная в валюте
